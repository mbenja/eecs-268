...
public:
   ...
   virtual void insert(int newPosition, const ItemType& newEntry) throw(std::runtime_error) = 0;
   ...
   virtual ItemType getEntry(int position) const throw(std::runtime_error) = 0;
   ...
   virtual void setEntry(int position, const ItemType& newEntry) throw(std::runtime_error) = 0;
